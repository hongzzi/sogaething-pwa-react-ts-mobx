...
//        return postRepository.save(new Post(null, input.getUploader_id(), false, input.getTitle(), input.getSale_date(), input.getContents(), (long) 0, null, null, input.getDeal(), "진행중"));
