...
// connect() 함수에서는 Sockjs 와 stomp client 를 이용하여 Spring Boot 에서 구성한 /websockethandler 엔드 포인트에 연결한다.
...
function onConnected() {
    ...
    // 명명된 목적지 "/app/chat.addUser"로 메세지를 보낸다.
