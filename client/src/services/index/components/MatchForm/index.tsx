    ...
    return (
        <Wrapper>
            <FormContainer>
                ...
                <InputContainer>
                    <Input type={'number'} value={match.minPrice} placeholder={'최소금액'} onChange={handleChangeMinPrice} />
                    <Span>~</Span>
                    <Input type={'number'} value={match.maxPrice} placeholder={'최대금액'} onChange={handleChangeMaxPrice} />
                </InputContainer>
                <InputContainer>
